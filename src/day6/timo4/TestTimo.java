...
public class TestTimo {
    public static void main(String[] args) {
        ...
        //打印初始血量和攻击
        System.out.println(gl.name+"HP:"+gl.hp+"\tAD:"+gl.ad);
        System.out.println(js.name+"HP:"+js.hp+"\tAD:"+js.ad);
        System.out.println(tm.name+"HP:"+tm.hp+"\tAD:"+tm.ad);
        //攻击循环
        while (flag){
            //初始化攻击指示
            instruct = 0;
            for (int i = 0; i <2 ; i++) {
                ...
                System.out.println(tm.name+"剩余HP:"+tm.hp+"\t"+gl.name+"剩余HP:"+gl.hp+"\t"+js.name+"剩余HP:"+js.hp+"\n");
            }
            //胜负判断
            if (tm.hp==0){
